      ...
      <div class="container flex flex-col md:flex-row-reverse items-start justify-start md:justify-between">
        ...
        <div class="md:w-1/2 w-full">
          <div class="text-center md:text-left">
            ...
            <br><br>
            Mantenerme al tanto de los últimos estándares y pautas de accesibilidad web me motiva a seguir aprendiendo y mejorando en mi campo profesional. Por último, valoro el impacto positivo que tendrá en mi perfil profesional el destacarme como un entusiasta en accesibilidad web.</p>
          </div>
        </div>
      </div>
    `;
      ...
      <div class="container flex flex-col md:flex-row-reverse items-start justify-start md:justify-between">
        ...
        <div class="md:w-1/2 w-full">
          <div class="text-center md:text-left">
            ...
            Me esfuerzo mucho para dominar este idioma y poder comunicarme globalmente, acceder a información actualizada y mantenerme competitivo en el campo de la tecnología. Mi dedicación refleja mi compromiso con mi crecimiento y éxito profesional. </p>
          </div>
        </div>
      </div>
    `;
